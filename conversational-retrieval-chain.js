...
const retPrompt = ChatPromptTemplate.fromMessages([
...
const chat_history=[
    ...
    new AIMessage("Hi How Can I assit today?"),
    new HumanMessage("My name is Denu and i'm student"),
    new AIMessage("Hei,Denu what do you want to do???"),
